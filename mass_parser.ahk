...
; ═══════════════════════════════════════════════════════════════════════════════
;  mass_parser.ahk — the mass text format: parse it, and escape it back out.
; ───────────────────────────────────────────────────────────────────────────────
...
;  serialiser half — BuildBlock in mass_gui.ahk writes what EscQ produces.
;
;  Kept apart from the GUI so the format has one definition. Included by
;  mass_gui.ahk and shares its globals.
; ═══════════════════════════════════════════════════════════════════════════════
