...
#Include "hotstring_index.ahk"
#Include "hotstring_overloads.ahk"
; ═══════════════════════════════════════════════════════════════════════════════
;  hotstrings_gui.ahk — a searchable window over the whole message library.
; ───────────────────────────────────────────────────────────────────────────────
;  Reads every hotstring via hotstring_index.ahk (see there) and lists them so you
