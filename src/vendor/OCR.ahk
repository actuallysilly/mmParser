...
;
;  OCR.ahk - UWP Windows.Media.Ocr wrapper for AutoHotkey v2
;  Author:   Descolada
;  Source:   https://github.com/Descolada/OCR
;  License:  MIT (Copyright (c) 2023 Descolada) - full text in OCR.LICENSE
;  Vendored: 2026-07-15
;
;  Used by ocr_grab.ahk for the "OCR screen region -> Add Hotkey" feature.
;  Runs fully offline against the OCR engine already built into Windows.
;  Update by re-downloading from the URL above; keep this header.
; =============================================================================
